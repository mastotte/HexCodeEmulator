...
void CPU::loadByteUnsigned(const int reg_a, const int reg_b, const int immediate) {
...
void CPU::branchOnNotEqual(const int reg_a, const int reg_b, const int immediate) {
    if (registers[reg_a] != registers[reg_b]) {
        programCounter -= 4;
        programCounter += 4 + 4 * immediate;
    }
...
void CPU::subtract(const int reg_a, const int reg_b, const int reg_c, const int shift_value) {
    registers[reg_c] = registers[reg_a] - registers[reg_b];
    //std::cout << "sub" << std::endl;
}

void CPU::or_Op(const int reg_a, const int reg_b, const int reg_c, const int shift_value) {
    registers[reg_c] = registers[reg_a] | registers[reg_b];
    //std::cout << "or" << std::endl;
}

void CPU::nor(const int reg_a, const int reg_b, const int reg_c, const int shift_value) {
    registers[reg_c] = !(registers[reg_a] | registers[reg_b]);
    //std::cout << "nor" << std::endl;
}
//--------------------- 2.2.4-2.2.7 (Max) --------------------
void CPU::add(const int reg_a, const int reg_b, const int reg_c, const int shift_value) {
    //std::cout << "add during reg a " << registers[reg_a] << " reg b " << registers[reg_b] << "reg c " << registers[reg_c] << std::endl;
    registers[reg_c] = registers[reg_a] + registers[reg_b];
}

void CPU::shiftRightArithmetic(const int reg_a, const int reg_b, const int reg_c, const int shift_value) {
    //std::cout << "sra" << std::endl;
    registers[reg_c] = (signed)registers[reg_b] >> shift_value;
}

void CPU::bitwise_and(const int reg_a, const int reg_b, const int reg_c, const int shift_value) {
    registers[reg_c] = registers[reg_a] & registers[reg_b];
    //std::cout << "and" << std::endl;
}

void CPU::jumpRegister(const int reg_a, const int reg_b, const int reg_c, const int shift_value) {
    programCounter -= 4;
...
void CPU::setLessThan(const int reg_a, const int reg_b, const int reg_c, const int shift_value) {
    registers[reg_c] = (registers[reg_a] < registers[reg_b]);
